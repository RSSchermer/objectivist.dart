...
/// image that is linked to the specular exponent of the material.
///
/// During rendering, the texture value should be multiplied by the `Ns` value
/// set with an [NsStatement].
class MapNsStatement implements MtlStatement {
  ...
  /// Instantiates a new [MapNsStatement].
  MapNsStatement(this.filename,
      {this.blendU: true,
      this.blendV: true,
  ...
  void acceptVisit(MtlStatementVisitor visitor) {
    visitor.visitMapNsStatement(this);
  }
  ...
  String toString() => 'MapNsStatement($filename, blendU: $blendU, blendV: '
