...
/// Specifies a scalar texture file, a bump procedural texture file or an image
/// that is used to deform the surface of an object, creating surface roughness.
class DispStatement implements MtlStatement {
  /// The name of the scalar texture file, the bump procedural texture file or
  /// the image file.
  ...
  /// Instantiates a new [DispStatement].
  DispStatement(this.filename,
      {this.blendU: true,
      this.blendV: true,
  ...
  String toString() => 'DispStatement($filename, blendU: $blendU, blendV: '
