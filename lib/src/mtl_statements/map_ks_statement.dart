...
/// that is applied to the specular reflectivity of the material.
///
/// During rendering, the texture value should be multiplied by the `Ks` value
/// set with a [KsStatement].
class MapKsStatement implements MtlStatement {
  ...
  /// Instantiates a new [MapKsStatement].
  MapKsStatement(this.filename,
      {this.blendU: true,
      this.blendV: true,
  ...
  void acceptVisit(MtlStatementVisitor visitor) {
    visitor.visitMapKsStatement(this);
  }
  ...
  String toString() => 'MapKsStatement($filename, blendU: $blendU, blendV: '
