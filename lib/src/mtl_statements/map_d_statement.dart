...
/// image that is linked to the dissolve of the material.
///
/// During rendering, the texture value should be multiplied by the `d` value
/// set with a [DStatement].
class MapDStatement implements MtlStatement {
  ...
  /// Instantiates a new [MapDStatement].
  MapDStatement(this.filename,
      {this.blendU: true,
      this.blendV: true,
  ...
  void acceptVisit(MtlStatementVisitor visitor) {
    visitor.visitMapDStatement(this);
  }
  ...
  String toString() => 'MapDStatement($filename, blendU: $blendU, blendV: '
