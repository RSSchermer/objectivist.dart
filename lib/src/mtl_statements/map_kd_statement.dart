...
/// that is applied to the diffuse reflectivity of the material.
///
/// During rendering, the texture value should be multiplied by the `Kd` value
/// set with a [KdStatement].
class MapKdStatement implements MtlStatement {
  ...
  /// Instantiates a new [MapKdStatement].
  MapKdStatement(this.filename,
      {this.blendU: true,
      this.blendV: true,
  ...
  void acceptVisit(MtlStatementVisitor visitor) {
    visitor.visitMapKdStatement(this);
  }
  ...
  String toString() => 'MapKdStatement($filename, blendU: $blendU, blendV: '
