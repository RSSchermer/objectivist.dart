...
void main() {
  test('statementizing examples/trimmed_nurbs_surface.obj results in the correct statements without errors', () async {
    final resource = new Resource('test/functional/obj/examples/trimmed_nurbs_surface.obj');
