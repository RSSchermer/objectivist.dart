...
void main() {
  test('statementizing examples/obj/trimming_regions_with_holes.obj results in the correct statements without errors', () async {
    final resource = new Resource('test/examples/obj/trimming_regions_with_holes.obj');
