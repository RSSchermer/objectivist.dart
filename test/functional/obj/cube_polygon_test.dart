...
void main() {
  test('statementizing examples/cube_polygon.obj results in the correct statements without errors', () async {
    final resource = new Resource('test/functional/obj/examples/cube_polygon.obj');
